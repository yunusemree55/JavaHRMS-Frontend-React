...
import JobAdvertisementDetail from "./components/jobAdvertisementComponents/JobAdvertisementDetail";
...
import CvAddPage from "./pages/CvAddPage";
...
function App() {
  return (
      ...
      <Routes>
        ...
        <Route path="/cv/add"  element={<CvAddPage />} />
